...
class DataLayer extends Model {
    ...
    public function getUsersMessage($username) {
        $users = StoreUser::where('username', $username)->get(['deleted_products']);
        return $users[0]->deleted_products;
    }
    ...
    public function changeDeletedField($id, $brand, $model, $color, $status) {
        ...
        $messaggio = $brand . " " . $model . " " . $color . " " . $status;
    ...
    public function capitoDeletedField($username) {
        $user = StoreUser::where('username', $username)->get()->first();
        $deleted_products = $user->deleted_products;
        $user->deleted_products = "";
        $user->save();
