...
<li class="breadcrumb-item active"><a href="{{ route('macro', $iden) }}}">{{$macro_name}}</a></li>
@stop
        ...
        <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <div class="card card-errore text-center mb-3">
                            ...
                            <div class="card-body">
                                <p class="card-text my-4">Non ci sono prodotti per questa categoria. Ci scusiamo per il disagio.<br>
            ...
            <table id="myTabella" class="table table-responsive" style="width: 100%">
                ...
                <tbody>
                    ...
                    @if($product->macro_categories_id == $iden)
                    <tr>
