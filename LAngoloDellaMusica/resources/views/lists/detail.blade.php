                            ...
                            @if($logged)
                                @if($siono)
                                        <form id="formRemove{{$prod->id}}" class="formRemove" action="{{ route('wishlist.deletePost') }}" method="post">
                                            ...
                                            <button class="d-none d-md-block bottone bottone_elimina bold" id="bottoneRemove" type="submit">Wishlist <i class="fas fa-trash-alt"></i></button>
                                ...
                                @else
                                    <form id="formAdd{{$prod->id}}" class="formAdd" action="{{ route('wishlist.addPost') }}" method="post">
                                        ...
                                        <button class="d-none d-md-block bottone bottone_wishlist bold" id="bottoneAdd" type="submit">Wishlist <i class="far fa-star"></i></button>
