...
@section('menu_nav')
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item active" href="{{ route('corsi') }}">Corsi di Musica</a>
        </div>
    </li>
    <li class="nav-item">
    ...
    <div class="container">
        <div class="row centra">
            <div class="col-md-6 col-sm-12">
                <h2>Corsi di Musica</h2>
                <p>
                    Offriamo corsi individuali di musica per bambini, ragazzi e adulti.<br>
                    Tutti i corsi sono tenuti da insegnanti professionisti ed esperti dello strumento che sceglierete.
                </p>
                <p>
                    Proponiamo corsi di:
                </p>
                <ul>
                    <li>Chitarra classica ed elettrica</li>
                    <li>Basso</li>
                    <li>Batteria</li>
                    <li>Percussioni</li>
                    <li>Pianoforte e strumenti a tastiera</li>
                    <li>Violino</li>
                    <li>Violoncello</li>
                    <li>Canto moderno e lirico</li>
                    <li>Solfeggio e teoria musicale</li>
                    <li>Produzione e registrazione</li>
                </ul>
                <p>
                    Per qualunque domanda, informazione, per fissare le tue lezioni e conoscere i prezzi, chiama, scrivi o passa in negozio. Ti aspettiamo!
                </p>
            </div>
            <div class="col-md-6">
                <img src="pics/corsi.png" alt="sala" class="img-fluid">
            </div>
        </div>
    </div>
@stop